...
Sub Table1_Exit
    ...
    If B2SOn = true or PuPStatus Then Controller.Stop
End Sub
...
Sub CheckTilt 'Called when table is nudged
    ...
    If(Tilt > TiltSensitivity)AND(Tilt <= 15)Then 'show a warning
        DMD "_", CL("CAREFUL"), "_", eNone, eBlinkFast, eNone, 1000, True, "" : PuPEvent 847
    End if
    If(NOT Tilted)AND Tilt > 15 Then 'If more that 15 then TILT the table
        'display Tilt
        InstantInfoTimer.Enabled = False
        DMDFlush
        DMD CL("YOU"), CL("TILTED"), "", eNone, eNone, eNone, 3000, True, "vo_tilt" &RndNbr(3) : PuPEvent 848
    ...
    Else
        ...
        If PlayersPlayingGame > 1 Then
            Select Case CurrentPlayer
                Case 1:DMD "", CL("PLAYER 1"), "", eNone, eNone, eNone, 1000, True, "vo_player1" :PupEvent 10: PuPEvent 905
                Case 2:DMD "", CL("PLAYER 2"), "", eNone, eNone, eNone, 1000, True, "vo_player2" :PupEvent 11: PuPEvent 906
                Case 3:DMD "", CL("PLAYER 3"), "", eNone, eNone, eNone, 1000, True, "vo_player3" :PupEvent 12: PuPEvent 907
                Case 4:DMD "", CL("PLAYER 4"), "", eNone, eNone, eNone, 1000, True, "vo_player4" :PupEvent 13: PuPEvent 908
            End Select
        Else
            DMD "", CL("PLAYER 1"), "", eNone, eNone, eNone, 1000, True, "vo_youareup" : :PupEvent 10: PuPEvent 905
        End If
    End If
End Sub
    ...
    If(bGameInPLay = True)AND(Tilted = False)Then
        ...
        If(bBallSaverActive = True)Then
            ...
            If NOT bMultiBallMode Then
                DMD "_", CL("BALL SAVED"), "_", eNone, eBlinkfast, eNone, 2500, True, "vo_ballsaved"&RndNbr(6) : If Table1.ShowDT = False then PFRandom : End If
...
Sub AwardCombo
    ...
    Select Case ComboCount
        Case 1:DMD CL("COMBO"), CL(FormatScore(ComboValue(CurrentPlayer))), "", eNone, eNone, eNone, 1500, True, "vo_combo1":ComboHits(CurrentPlayer) = ComboHits(CurrentPlayer) + 1  :PuPEvent 41: PuPEvent 922
        Case 2:DMD CL("2X COMBO"), CL(FormatScore(ComboValue(CurrentPlayer) * 2)), "", eNone, eNone, eNone, 1500, True, "vo_combo2":ComboHits(CurrentPlayer) = ComboHits(CurrentPlayer) + 1 :PuPEvent 42: PuPEvent 923
        Case 3:DMD CL("3X COMBO"), CL(FormatScore(ComboValue(CurrentPlayer) * 3)), "", eNone, eNone, eNone, 1500, True, "vo_combo3":ComboHits(CurrentPlayer) = ComboHits(CurrentPlayer) + 1 :PuPEvent 43: PuPEvent 924
        Case 4:DMD CL("4X COMBO"), CL(FormatScore(ComboValue(CurrentPlayer) * 4)), "", eNone, eNone, eNone, 1500, True, "vo_combo4":ComboHits(CurrentPlayer) = ComboHits(CurrentPlayer) + 1 :PuPEvent 44: PuPEvent 925
        Case 5:DMD CL("5X COMBO"), CL(FormatScore(ComboValue(CurrentPlayer) * 5)), "", eNone, eNone, eNone, 1500, True, "vo_combo5":ComboHits(CurrentPlayer) = ComboHits(CurrentPlayer) + 1 :PuPEvent 45 : PuPEvent 926
        Case Else:DMD CL("SUPER COMBO"), CL(FormatScore(ComboValue(CurrentPlayer) * 10)), "", eNone, eNone, eNone, 1500, True, "vo_supercombo":ComboHits(CurrentPlayer) = ComboHits(CurrentPlayer) + 1 :PuPEvent 46: PuPEvent 927
    End Select
...
'	debug.print "seconds: " &  cSlowAttCount
	select case cSlowAttCount
		...
		case 533: roachmove
		case 545: roachmove
		case 550: PlaySound "vo_taunt" &RndNbr(66)  :PuPEvent 118
		case 558: roachmove
		case 578: roachmove
		case 598: roachmove
		case 610: roachmove
		...
		case 655: roachmove
		case 670: roachmove
		case 960: PlaySound "vo_wakeup1"   :PuPEvent 119
...
Sub InstantInfo
    ...
    Select Case Mode(CurrentPlayer, 0)
        ...
        Case 12
            DMD CL("FIND PENNYWISE"), CL("SHOOT JACKPOTS"), "", eNone, eNone, eNone, 2000, True, "" : pupevent 811
        Case 13
            DMD CL("FIGHT PENNYWISE"), CL("SHOOT JACKPOTS"), "", eNone, eNone, eNone, 2000, True, "" : pupevent 812
        Case 14
            DMD CL("KILL PENNYWISE"), CL("SHOOT PENNYWISE"), "", eNone, eNone, eNone, 2000, True, "" : pupevent 813
    End Select
...
Sub CheckBumperHits                'to enable superbumpers
    If BumperHits(CurrentPlayer)MOD 10 = 0 Then
        If BumperValue = 5000 Then 'turn on the bumper lights
            DMD CL("SUPER BUMPERS"), CL("ARE LIT"), "", eNone, eNone, eNone, 1500, True, "" : pupevent 851
            BumperValue = 50000
            Lbumper1.State = 1
            Lbumper2.State = 1
            Lbumper3.State = 1
...
Sub Trigger013_Hit
    ...
    If bAddABallReady AND bMultiBallMode Then 'award add-a-ball but only if during multiball 
        DMD "_", CL("ADD-A-BALL"), "", eNone, eBlink, eNone, 1500, True, "" : pupevent 852
        bAddABallReady = False
        li059.State = 0
        LightEffect 1
        AddMultiball 1
    ...
    If AddABallHits(CurrentPlayer) = 0 Then 'enable add-a-ball light
        DMD "_", CL("ADD-A-BALL IS LIT"), "", eNone, eBlink, eNone, 1500, True, "" : pupevent 853
        bAddABallReady = True
        li059.State = 1
    End If
    ' check modes
...
Sub StartMode
    ...
    PuPEvent 60+Mode(CurrentPlayer, 0) 
    Select Case Mode(CurrentPlayer, 0)
        Case 1               'Eddie
            DMD CL("RESCUE EDDIE"), CL("SHOOT THE SPINNER"), "", eNone, eNone, eNone, 3500, True, "vo_saveeddie" : PuPEvent 800
			...
			End If
        Case 2 'Ben
            DMD CL("RESCUE BEN"), CL("HIT THE POP BUMPERS"), "", eNone, eNone, eNone, 3500, True, "vo_taunt34" : PuPEvent 801
			...
			End If
        Case 3 'Richie
            DMD CL("RESCUE RICHIE"), CL("SHOOT THE RAMPS"), "", eNone, eNone, eNone, 2500, True, "vo_taunt23" : PuPEvent 802
			...
			End If
        Case 4 'Beverly
            DMD CL("RESCUE BEVERLY"), CL("SHOOT THE ORBIT"), "", eNone, eNone, eNone, 2500, True, "vo_taunt20" : PuPEvent 803
        ...
        Case 5 'Stanley
            Select Case RndNbr(2)
                Case 1:DMD CL("RESCUE STANLEY"), CL("SHOOT THE LIGHTS"), "", eNone, eNone, eNone, 2500, True, "vo_savestanley" : PuPEvent 804
        ...
        Case 6 'Mike - shoot lights one at a time
            DMD CL("RESCUE MIKE"), CL("SHOOT THE LIGHTS"), "", eNone, eNone, eNone, 2000, True, "vo_savemike" : PuPEvent 805
			...
			End If
        Case 7 'Bill
            DMD CL("RESCUE BILL"), CL("SHOOT THE TARGETS"), "", eNone, eNone, eNone, 2000, True, "vo_savebill" : PuPEvent 806
        ...
        ' Evasion modes
        Case 8 'Patrick
            DMD CL("RUN FROM PATRICK"), CL("COMPLETE YELLOW BANK"), "", eNone, eNone, eNone, 2500, True, "vo_runpatrick" : PuPEvent 807
			...
			End If
        Case 9 'Bowers
            DMD CL("RUN FROM BOWERS"), CL("COMPLETE GREEN BANK"), "", eNone, eNone, eNone, 3500, True, "vo_runhenry" &RndNbr(2) : PuPEvent 808
			...
			End If
        Case 10 'Belch
            DMD CL("RUN FROM BELCH"), CL("COMPLETE BLUE BANK"), "", eNone, eNone, eNone, 7500, True, "vo_runbelchor" &RndNbr(2) : PuPEvent 809
			...
			End If
        Case 11 'Victor
            DMD CL("RUN FROM VICTOR"), CL("HIT A COMBO"), "", eNone, eNone, eNone, 3000, True, "vo_runvictor" : PuPEvent 810
        ...
        'wizard modes
        Case 12 'wizard 1
            DMD CL("FIND PENNYWISE"), CL("SHOOT JACKPOTS"), "", eNone, eNone, eNone, 2000, True, "vo_wizards1" : PuPEvent 811
            AddMultiball 2
            ChangeGI red
            ChangeGIIntensity 2
			...
			End If
        Case 13              'wizard 2
            DMD CL("FIGHT PENNYWISE"), CL("SHOOT JACKPOTS"), "", eNone, eNone, eNone, 2000, True, "vo_wizards2" : PuPEvent 812
            AddMultiball 3
            ChangeGi red
            ChangeGIIntensity 2
            RndJackpot_Timer 'turn on a Jackpot
			...
			End If
        Case 14              'Wizard 3
            DMD CL("KILL PENNYWISE"), CL("SHOOT PENNYWISE"), "", eNone, eNone, eNone, 2000, True, "vo_wizards3" : PuPEvent 813
            AddMultiball 4
            ChangeGi red
            ChangeGIIntensity 2
            JackpotLight(5) = 2
    ...
    Select Case Mode(CurrentPlayer, 0)
        Case 1
            If SpinCount1 = SpinsToCount1 Then
                DMD CL("YOU RESCUED EDDIE"), "", "_", eNone, eNone, eNone, 1500, True, "vo_eddiesaved" : PuPEvent 814
                WinMode
                SPJackpotLight(5) = 2
        ...
        Case 2
            If BumperHits2 = BumpersToHit2 Then
                DMD CL("YOU RESCUED BEN"), "", "_", eNone, eNone, eNone, 1500, True, "vo_bensaved" : PuPEvent 815
                WinMode
                SPJackpotLight(5) = 2
                SuperJackpotTimer.Enabled = 1
            End if
        Case 3
            If RampHits3 = RampsToHit3 Then
                DMD CL("YOU RESCUED RICHIE"), "", "_", eNone, eNone, eNone, 1500, True, "vo_richiesaved" : PuPEvent 816
                WinMode
                SPJackpotLight(5) = 2
                SuperJackpotTimer.Enabled = 1
            End if
        Case 4
            If OrbitHits4 = OrbitsToHit4 Then
                DMD CL("YOU RESCUED BEVERLY"), "", "_", eNone, eNone, eNone, 1500, True, "vo_beverlysaved" : PuPEvent 817
                WinMode
                SPJackpotLight(5) = 2
                SuperJackpotTimer.Enabled = 1
            End if
        Case 5
            If LightHits5 = LightsToHit5 Then
                DMD CL("YOU RESCUED STANLEY"), "", "_", eNone, eNone, eNone, 1500, True, "vo_stanleysaved" : PuPEvent 818
                WinMode
                SPJackpotLight(5) = 2
                SuperJackpotTimer.Enabled = 1
            End if
        Case 6
            If LightHits6 = LightsToHit6 Then
                DMD CL("YOU RESCUED MIKE"), "", "_", eNone, eNone, eNone, 1500, True, "vo_mikesaved" : PuPEvent 819
                WinMode
                SPJackpotLight(5) = 2
                SuperJackpotTimer.Enabled = 1
            Else
        ...
        Case 7
            If TargetHits7 = TargetsToHit7 Then
                DMD CL("YOU RESCUED BILL"), "", "_", eNone, eNone, eNone, 1500, True, "vo_billsaved" : PuPEvent 820
                WinMode
                SPJackpotLight(5) = 2
                SuperJackpotTimer.Enabled = 1
            End if
        Case 8
            DMD CL("YOU RUN FROM PATRICK"), "", "_", eNone, eNone, eNone, 1500, True, "vo_patrickrun" : PuPEvent 821
            WinMode
            ExtraBallIsLit
        Case 9
            DMD CL("YOU RUN FROM BOWERS"), "", "_", eNone, eNone, eNone, 1500, True, "vo_henryrun" : PuPEvent 822
            WinMode
            ExtraBallIsLit
        Case 10
            DMD CL("YOU RUN FROM BELCH"), "", "_", eNone, eNone, eNone, 1500, True, "vo_belchrun" : PuPEvent 823
            WinMode
            ExtraBallIsLit
        Case 11
            DMD CL("YOU RUN FROM VICTOR"), "", "_", eNone, eNone, eNone, 1500, True, "vo_victorrun" : PuPEvent 824
            WinMode
            ExtraBallIsLit
...
Sub StopMode 'called at the end of a ball and also from the stopmode timer during times modes
    Dim i
    PuPEvent 74+Mode(CurrentPlayer, 0)
    Select Case Mode(CurrentPlayer, 0)
        Case 0:PlaySound "vo_drain" &RndNbr(20) : If VRRoom > 0 Then VRBGFLITtimer.enabled = true
        Case 1:DMD CL("EDDIE IS MINE"), "", "_", eNone, eNone, eNone, 1500, True, "vo_drain" &RndNbr(20) : If VRRoom > 0 Then VRBGFlashFail.enabled = 1 : PuPEvent 825
        Case 2:DMD CL("BEN IS MINE"), "", "_", eNone, eNone, eNone, 1500, True, "vo_bendead" : If VRRoom > 0 Then VRBGFlashFail.enabled = 1 : PuPEvent 826
        Case 3:DMD CL("RICHIE IS MINE"), "", "_", eNone, eNone, eNone, 1500, True, "vo_richiedead" : If VRRoom > 0 Then VRBGFlashFail.enabled = 1 : PuPEvent 827
        Case 4:DMD CL("BEVERLY IS MINE"), "", "_", eNone, eNone, eNone, 1500, True, "vo_beverlydead" : If VRRoom > 0 Then VRBGFlashFail.enabled = 1 : PuPEvent 828
        Case 5:DMD CL("STANLEY IS MINE"), "", "_", eNone, eNone, eNone, 1500, True, "vo_stanleydead" : If VRRoom > 0 Then VRBGFlashFail.enabled = 1 : PuPEvent 829
        Case 6:DMD CL("MIKE IS MINE"), "", "_", eNone, eNone, eNone, 1500, True, "vo_mikedead" : If VRRoom > 0 Then VRBGFlashFail.enabled = 1 : PuPEvent 830
        Case 7:DMD CL("BILL IS MINE"), "", "_", eNone, eNone, eNone, 1500, True, "vo_billdead" : If VRRoom > 0 Then VRBGFlashFail.enabled = 1 : PuPEvent 831
        Case 8:DMD CL("PATRICK GOT YOU"), "", "_", eNone, eNone, eNone, 1500, True, "vo_patrickwon" : If VRRoom > 0 Then VRBGFlashFail.enabled = 1 : PuPEvent 832
        Case 9:DMD CL("HENRY GOT YOU"), "", "_", eNone, eNone, eNone, 1500, True, "vo_henrywon" : If VRRoom > 0 Then VRBGFlashFail.enabled = 1 : PuPEvent 833
        Case 10:DMD CL("BELCH GOT YOU"), "", "_", eNone, eNone, eNone, 1500, True, "vo_benchorwon" : If VRRoom > 0 Then VRBGFlashFail.enabled = 1 : PuPEvent 834
        Case 11:DMD CL("VICTOR GOT YOU"), "", "_", eNone, eNone, eNone, 1500, True, "vo_victorwon" : If VRRoom > 0 Then VRBGFlashFail.enabled = 1 : PuPEvent 835
        Case 12:DMD CL("YOU FOUND"), CL("PENNYWISE"), "_", eBlink, eBlink, eNone, 3000, True, "vo_wizards4" : PuPEvent 836
        Case 13:DMD CL("YOU FOUGHT"), CL("PENNYWISE"), "_", eBlink, eBlink, eNone, 3000, True, "vo_wizards5" : PuPEvent 837
        Case 14:DMD CL("YOU ALMOST KILLED"), CL("PENNYWISE"), "_", eBlink, eBlink, eNone, 2000, True, "vo_wizards6" : PuPEvent 838
                 DMD CL("BUT HE ESCAPED"), CL("HA HA HA"), "_", eBlink, eBlink, eNone, 2000, True, "" : PuPEvent 839
    End Select
    For i = 1 to 14
        If Mode(CurrentPlayer, i) = 2 Then Mode(CurrentPlayer, i) = 0
    Next
...
Sub WinMode
    PuPEvent 88+Mode(CurrentPlayer, 0)
    ...
    LightEffect 2
    GiEffect 3
    DMD "_", CL("MODE COMPLETED"), "_", eNone, eBlinkFast, eNone, 1500, True, "": PuPEvent 939
    DOF 139, DOFPulse
    StopMode2
	If VRRoom > 0 Then
...
Sub EndModeTimer_Timer '1 second timer to count down to end the timed modes
    ...
    If EndModeCountdown < 61 Then
        Select Case EndModeCountdown
            Case 16:DMD "_", CL("TIME IS RUNNING OUT"), "_", eNone, eBlinkFast, eNone, 1000, True, "" : If VRRoom > 0 Then VRBGFlashIT.enabled = True : pupEvent 103: PuPEvent 940
            Case 10:DMD "_", CL("10"), "_", eNone, eBlinkFast, eNone, 1000, True, "vo_10" : PuPEvent 840
            ...
            Case 1:DMD "_", CL("1"), "_", eNone, eBlinkFast, eNone, 1000, True, "vo_1" : PuPEvent 841
...
Sub Clock_Hit 'Center Lock
    ...
    If NOT bMultiBallMode Then 'in multiball the kicker should be already disabled
        ...
        Select Case BallsInLock(CurrentPlayer)
            Case 1
                DMD "_", CL("BALL 1 LOCKED"), "_", eNone, eBlink, eNone, 1500, True, "vo_ball1locked": PuPEvent 941 : If Table1.ShowDT = False then  StartITB : End If
                vpmtimer.addtimer 1500, "ClockExit '"
				If VRRoom > 0 Then
					VRBGFlashMB1.enabled = True
				End If
            Case 2
                DMD "_", CL("BALL 2 LOCKED"), "_", eNone, eBlink, eNone, 1500, True, "vo_ball2locked": PuPEvent 942 : If Table1.ShowDT = False then  StartITB2 : End If
                vpmtimer.addtimer 1500, "ClockExit '"
				If VRRoom > 0 Then
					VRBGFlashMB2.enabled = True
				End If
            Case 3
                DMD "_", CL("BALL 3 LOCKED"), "_", eNone, eBlink, eNone, 1500, True, "vo_ball3locked": PuPEvent 943
...
Sub StartMultiball
    ...
    li064.State = 0
    Tlock.Enabled = 0
    PuPEvent 110+MultiballType(CurrentPlayer)
    Select Case MultiballType(CurrentPlayer)
        Case 0 'normal multiball, no jackpots, use it for completing modes
            DMD "_", CL("MULTIBALL"), "_", eNone, eBlink, eNone, 1500, True, "vo_multiball" : PuPEvent 842
            AddMultiball 2
        Case 1 'Georgie - 7 ball - random jackpots
            DMD CL("GEORGIE"), CL("MULTIBALL"), "_", eBlink, eBlink, eNone, 1500, True, "" : PuPEvent 843
            RndJackpot_Timer
        ...
        Case 2 'Fear - 4 ball - jackpots on left ramp, nice for combos, dark mode
            DMD CL("FEAR OF THE DARK"), CL("MULTIBALL"), "_", eBlink, eBlink, eNone, 1500, True, "" : PuPEvent 844
            LowerRamp
            JackPotLight(2) = 2
            NightMode
            AddMultiball 3
        ...
        Case 3 'Float - 5 ball - jackpots on right ramp, nice for combos, green fog
            DMD CL("YOU WILL ALL FLOAT"), CL("MULTIBALL"), "_", eBlink, eBlink, eNone, 1500, True, "" : PuPEvent 845
            JackPotLight(8) = 2
            Start_Fog
            AddMultiball 4
			DOF 159, DOFoff'Turn Off Green Undercab
        ...
        Case 4 'Horrors - 7 ball - jackpots on orbits, all scores x balls in play
            DMD CL("HORRORS"), CL("MULTIBALL"), "_", eBlink, eBlink, eNone, 1500, True, "" : PuPEvent 846
            JackPotLight(2) = 2
            JackPotLight(9) = 2
            ChangeGi red
            ChangeGIIntensity 2
...
Dim pGameName       : pGameName="it_pinball_madness"  'pupvideos foldername, probably set to cGameName in realworld
...
Dim PuPlayer
Dim PuPStatus : PuPStatus=false  'dont touch
...
sub pDMDLabelMoveTO(LabName,LabValue,mLen,mColor,pStartX,pStartY,pEndX,pEndY)   'pmovestart is -1= left-off 0=current pos 1=right-off
...
sub pDMDLabelMoveTOFade(LabName,LabValue,mLen,mColor,pStartX,pStartY,pEndX,pEndY)   'pmovestart is -1= left-off 0=current pos 1=right-off
     if pUseFramePos=1 AND (pStartX+pStartY+pEndx+pendY)>4 Then 
                       pTranslatePos pStartX,pStartY
                       pTranslatePos pEndX,pEndY
     end IF 
...
Sub pDMDScrollBig(LabName,msgText,timeSec,mColor) 'timeSec in MS
if timeSec<20 Then timeSec=timeSec*1000
PuPlayer.LabelSet pDMD,LabName,msgText,0,"{'mt':1,'at':2,'xps':1,'xpe':-1,'len':" & (timeSec) & ",'mlen':" & (timeSec*1) & ",'tt':0,'fc':" & mColor & "}"
end sub

Sub pDMDScrollBigV(LabName,msgText,timeSec,mColor) 'timeSec in MS
if timeSec<20 Then timeSec=timeSec*1000
PuPlayer.LabelSet pDMD,LabName,msgText,0,"{'mt':1,'at':2,'yps':1,'ype':-1,'len':" & (timeSec) & ",'mlen':" & (timeSec*0.8) & ",'tt':0,'fc':" & mColor & "}"
end sub


Sub pDMDZoomBig(LabName,msgText,timeSec,mColor,isVis,zStart,zEnd)  'timeSec in MS  zstart/end is % of screen height  notice aa antialias is 0 for big font zooms for performance.  'ns is size by %label height.
if timeSec<20 Then timeSec=timeSec*1000
PuPlayer.LabelSet pDMD,LabName,msgText,isVis,"{'mt':1,'at':3,'hstart':" & (zStart) & ",'hend':" & (zEnd) & ",'len':" & (timeSec) & ",'len':" & (timeSec*0.4) & ",'tt':" & 0 & ",'fc':" & mColor & ", 'ns':1, 'aa':0}"
end sub
...
'Sub PuPEvent(EventNum)				I passed this to the Line 10680
...
PuPlayer.LabelSet pDMD,lName,lValue,lvis,"{'mt':2,'xpos':"& xpos & ",'ypos':"&ypos&",'fonth':"&lsize&" }"
end Sub
...
'Sub CreateLabelImage(lName, lFilename,xpos, ypos, Iwidth, Iheight, pagenum, lvis)
	...
	'Page 1 (default score display)
        ...
        pupCreateLabelImage "MainPanel","huditems\\1PlayerDefault.png",0,923,1920,314,1,1




        pupCreateLabel      "Player","Player 1",dmddef,45,clred,134,900,1,1   
        pupCreateLabel      "Ball","Ball 1",dmddef,180,clBlue,1750,880,1,0       
        pupCreateLabel      "curScore","55,150,000",dmdscr,150,clred,336,983,1,1		

        
        pupCreateLabel      "Splash","JackPot!!!",dmddef,400,RGB(250,40,250),960,540,1,0

        

        pDMDLabelSetColorGradientPercent "Player",clred,rgb(50,40,40),20
        pDMDLabelSetColorGradientPercent "curScore",clred,rgb(50,40,40),20
        'pDMDLabelSetBorder "Player",clWhite,2,2,1
        pDMDLabelSetBorder "Ball",clWhite,3,3,1
        pDMDLabelSetBorder "Splash",clgreen,3,3,1
        pDMDLabelSetShadow "curScore",RGB(100,100,100),1,1,1
        
         pDMDLabelSetAutoSize "curscore",630,0
         PDMDLabelSetAlign "player",1,1
         pUpdateScores.enabled=true
         pDMDSetPage 1
...
Sub pUpdateScores_Timer()  'call this ONLY on timer 300ms is good enough
...
if lastscore<>Score(CurrentPlayer) then
       pDMDLabelSet "curscore",FormatNumber(Score(Currentplayer),0)
    '   pDMDLabelPulseTextex "curscore",FormatNumber(Score(Currentplayer),0),800,clred,1,100,120 
       lastscore=Score(Currentplayer)
end if
'puPlayer.LabelSet pDMD,"Player","P1" & 2,1,""
...
Select Case EOBCurIndex
        Case 0: pDMDSplashLinesEOB "EOB Bonus","EOB Case 0",2,rgb(0,0,250):TriggerScript 2200,"EndOfBallNext"  
        Case 1: pDMDSplashLinesEOB "EOB Hits","EOB Hits 1",2,rgb(0,250,0):TriggerScript 2200,"EndOfBallNext"  
        Case 2: pDMDSplashLinesEOB "EOB Hits","EOB Hits 2",2,rgb(0,250,0):TriggerScript 2200,"EndOfBallNext"  
        Case 3: pDMDSplashLinesEOB "EOB Hits","EOB Hits 3",2,rgb(250,0,0):TriggerScript 2200,"EndOfBallNext" 
        Case 4: pDMDSplashLinesEOB "EOB Hits","EOB Hits 4",2,rgb(0,100,250):TriggerScript 2200,"EndOfBallNext" 
        Case 5: pDMDSplashLinesEOB "EOB Hits","EOB Hits 5",2,rgb(0,100,250):TriggerScript 2200,"EndOfBallNext" 
        Case 6: EndOfBallEnd
    End Select
...
Sub pSetPlayerLayout(sNumPlayers)

Select Case sNumPlayers
      case 1:  pDMDLabelset "MainPanel","huditems\\1PlayerDefault.png" 
...
cPuPPack = "it_pinball_madness"    ' name of the PuP-Pack / PuPVideos folder for this table
...
Dim ITPF1Pos, Frames1
Frames1 = Array("IT1", "IT2", "IT3", "IT4")
...
Sub ITPFTimer_Timer
	ITPF.ImageA = Frames1(ITPF1Pos)
	ITPF1Pos = (ITPF1Pos + 1) MOD 4
	vpmtimer.addtimer 3000, "StopITPF '"
End Sub

Sub StopITPF
	ITPF.ImageA = "pfTransparent"
	ITPF.visible = 0
	ITPFTimer.Enabled = 0
	ITPF2Timer.Enabled = 0
	ITPF3Timer.Enabled = 0
End Sub

'***************************************************************Seq 2
Dim ITPF2Pos, Frames2
Frames2 = Array("IT5", "IT6", "IT7", "IT8")


Sub StartITPF2
	ITPF.visible = 1
	ITPF2Pos = 0
	ITPF2Timer.Enabled = 1
	PlaySound "JumpScare"
End Sub


Sub ITPF2Timer_Timer
	ITPF.ImageA = Frames2(ITPF2Pos)
	ITPF2Pos = (ITPF2Pos + 1) MOD 4
	vpmtimer.addtimer 3000, "StopITPF '"
End Sub

'***************************************************************Seq 3
Dim ITPF3Pos, Frames3
Frames3 = Array("IT9", "IT10", "IT11", "IT12")

Sub StartITPF3
	ITPF.visible = 1
	ITPF3Pos = 0
	ITPF3Timer.Enabled = 1
	PlaySound "JumpScare"
End Sub


Sub ITPF3Timer_Timer
	ITPF.ImageA = Frames3(ITPF3Pos)
	ITPF3Pos = (ITPF3Pos + 1) MOD 4
	vpmtimer.addtimer 3000, "StopITPF '"
End Sub
...
Dim ITB1Pos, Frames4
Frames4 = Array("ITB1", "ITB2", "ITB3", "ITB4")
...
Sub ITBTimer_Timer
	ITPF.ImageA = Frames4(ITB1Pos)
	ITB1Pos = (ITB1Pos + 1) MOD 4
	vpmtimer.addtimer 3000, "StopITB '"
End Sub
...
Dim ITB2Pos, Frames5
Frames5 = Array("ITB5", "ITB6", "ITB7", "ITB8")
...
Sub ITB2Timer_Timer
	ITPF.ImageA = Frames5(ITB2Pos)
	ITB2Pos = (ITB2Pos + 1) MOD 4
	vpmtimer.addtimer 3000, "StopITB '"
End Sub
...
Dim Round1Pos, Frame6
Frame6 = Array("Round1", "Round2")

Sub StartRoundScreen
	RoundScreen.visible = 1
	RoundScreen2.visible = 1
	Round1Pos = 0
	RoundScreenTimer.Enabled = 1
	PlaySound "JumpScare"
End Sub

Sub RoundScreenTimer_Timer
	RoundScreen2.ImageA = Frame6 (Round1Pos)
	RoundScreen.ImageA = Frame6 (Round1Pos)
	Round1Pos = (Round1Pos + 1) MOD 2
	vpmtimer.addtimer 3500, "StopRoundScreen '"
End Sub

Sub StopRoundScreen
	RoundScreen2.visible = 0
	RoundScreen.visible = 0
	RoundScreenTimer.Enabled = 0
End Sub
